...
<center>
	...
	<div class="col-lg-10 col-md-12 col-sm-12 col-lg-offset-1">
		<form class="form-register" action="doUpdate.jsp" method="post">
		  Username<br>
		  <input type="text" name="firstname" value="<%=session.getAttribute("fullname") %>" class="input-form" required>
		  <br>
		  Email<br>
		  <input type="email" name="email" value="<%=session.getAttribute("email") %>" class="input-form" required>
		  <br>
		  Password<br>
		  <input type="password" name="password" value="" class="input-form" required>
		  <br>
		  <br>
		  <input type="submit" name="Register" value="Edit Profile" class="input-login" required>  
		</form>
	</div>
</center>
