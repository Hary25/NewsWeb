...
<% 
	String query = "Select * FROM berita ORDER BY BeritaId DESC LIMIT 1,1;"; 
...
<% }%>
		<div class="col-md-3 atur-box ">
			<div class="card">
			  <img class="card-img-top photo_1" src="<%=rs.getString(4) %>" alt="Card image cap">
			  <div class="card-block">
			    <h4 class="card-title"><%=rs.getString(2) %></h4>
			    <p class="card-text"><%=rs.getString(5) %></p>
			   <p class="card-text">Category: <%=rs.getString(3) %></p>
			  </div>
			</div>
		</div>
